...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (letter.classList[0] == "valid" &&
                    capital.classList[0] == "valid" &&
                    number.classList[0] == "valid" &&
                    length.classList[0] == "valid" &&
                    match.classList[0] == "valid"); // TODO: Replace false with the correct condition
    console.log(letter.classList[0]=="invalid")
    if(condition) {
